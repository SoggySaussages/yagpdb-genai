...
type GenaiConfig struct {
	...
	OwnerIDAutomodNotified int64     `boil:"owner_id_automod_notified" json:"owner_id_automod_notified" toml:"owner_id_automod_notified" yaml:"owner_id_automod_notified"`
...
var GenaiConfigColumns = struct {
	...
	OwnerIDAutomodNotified: "owner_id_automod_notified",
}
...
var GenaiConfigTableColumns = struct {
	...
	OwnerIDAutomodNotified: "genai_configs.owner_id_automod_notified",
}
...
var GenaiConfigWhere = struct {
	...
	OwnerIDAutomodNotified whereHelperint64
}{
	...
	OwnerIDAutomodNotified: whereHelperint64{field: "\"genai_configs\".\"owner_id_automod_notified\""},
}
...
var (
	genaiConfigAllColumns            = []string{"guild_id", "enabled", "provider", "model", "key", "base_cmd_enabled", "max_tokens", "month_token_usage_to_date", "token_usage_last_reset", "owner_id_automod_notified"}
	genaiConfigColumnsWithoutDefault = []string{"guild_id", "enabled", "provider", "model", "key", "base_cmd_enabled"}
	genaiConfigColumnsWithDefault    = []string{"max_tokens", "month_token_usage_to_date", "token_usage_last_reset", "owner_id_automod_notified"}
